...
impl ExcelLookupApp {
    ...
    fn ui_header_row_picker(&mut self, ui: &mut egui::Ui, side: Side) {
    ...
    fn headers_from_preview(row: &[String], width: usize) -> Vec<String> {
